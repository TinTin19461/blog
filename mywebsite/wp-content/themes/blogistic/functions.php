<?php
/**
 * Blogistic functions and definitions
 *
...
if ( ! defined( 'BLOGISTIC_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	$theme_info = wp_get_theme();
	define( 'BLOGISTIC_VERSION', $theme_info->get( 'Version' ) );
}

if ( ! defined( 'BLOGISTIC_PREFIX' ) ) {
	// Replace the prefix of theme if changed.
	define( 'BLOGISTIC_PREFIX', 'blogistic_' );
}
 ...
 */
function blogistic_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Blogistic, use a find and replace
	 * to change 'blogistic' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'blogistic', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'blogistic' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'blogistic_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'blogistic_setup' );
 ...
 */
function blogistic_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'blogistic_content_width', 640 );
}
add_action( 'after_setup_theme', 'blogistic_content_width', 0 );

/**
 * Enqueue scripts and styles.
 */
function blogistic_scripts() {
	require_once get_theme_file_path( 'inc/wptt-webfont-loader.php' );
	wp_enqueue_style( 'blogistic-typo-fonts', wptt_get_webfont_url( esc_url_raw( blogistic_typo_fonts_url() ) ), array(), null );
	wp_enqueue_style( 'blogistic-style', get_stylesheet_uri(), array(), BLOGISTIC_VERSION );
	wp_add_inline_style( 'blogistic-style', blogistic_current_styles() );
	// wp_add_inline_style( 'blogistic-style', blogistic_custom_styles() );
	wp_enqueue_style( 'blogistic-main', get_template_directory_uri() . '/assets/css/main.css', [], BLOGISTIC_VERSION, 'all' );
	wp_enqueue_style( 'blogistic-aimation', get_template_directory_uri() . '/assets/css/animation.css', [], BLOGISTIC_VERSION, 'all' );
	wp_enqueue_style( 'blogistic-preloader', get_template_directory_uri() . '/assets/css/preloader.css', [], BLOGISTIC_VERSION, 'all' );
	wp_enqueue_style( 'blogistic-additional', get_template_directory_uri() . '/assets/css/additional.css', [], BLOGISTIC_VERSION, 'all' );
	wp_enqueue_style( 'blogistic-responsive', get_template_directory_uri() . '/assets/css/responsive.css', [], BLOGISTIC_VERSION, 'all' );
	wp_enqueue_style( 'blogistic-rtl', get_template_directory_uri() . '/assets/css/rtl.css', [], BLOGISTIC_VERSION, 'all' );
	...
	wp_enqueue_style( 'aos', get_template_directory_uri() .'/assets/external/aos/aos.css', [], BLOGISTIC_VERSION, 'all' );
	wp_style_add_data( 'blogistic-style', 'rtl', 'replace' );

	wp_enqueue_script( 'slick', get_template_directory_uri() . '/assets/external/slick/slick.min.js', array(), BLOGISTIC_VERSION, true );
	wp_enqueue_script( 'blogistic-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), BLOGISTIC_VERSION, true );
	wp_enqueue_script( 'blogistic-js', get_template_directory_uri() . '/assets/js/theme.js', ['jquery','jquery-masonry'], BLOGISTIC_VERSION, true );
	wp_enqueue_script( 'magnific-popup', get_template_directory_uri() . '/assets/external/magnific-popup/magnific-popup.js', [], BLOGISTIC_VERSION, true );
	wp_enqueue_script( 'aos', get_template_directory_uri() . '/assets/external/aos/aos.js', [], BLOGISTIC_VERSION, true );
	wp_enqueue_media();

	wp_localize_script( 'blogistic-js', 'blogisticObject', [
		'ajaxUrl'   => admin_url( 'admin-ajax.php' ),
		'_wpnonce'  => wp_create_nonce( 'blogistic-security-nonce' ),
		'isArchive'	=> ( is_archive() || is_home() || ( BIT\blogistic_get_customizer_option( 'archive_post_layout' ) == 'masonry' ) ),
		// carousel slider options
		'carouselArrows'	=> BIT\blogistic_get_customizer_option( 'carousel_show_arrows' ),
		'carouselFade'	=> BIT\blogistic_get_customizer_option( 'carousel_show_fade' ),
		'carouselInfiniteLoop'	=> BIT\blogistic_get_customizer_option( 'carousel_slider_infinite_loop' ),
		'carouselAutoplay'	=> BIT\blogistic_get_customizer_option( 'carousel_slider_autoplay' ),
		'carouselAutoplaySpeed'	=> BIT\blogistic_get_customizer_option( 'carousel_slider_autoplay_speed' ),
		'carouselSpeed'	=> BIT\blogistic_get_customizer_option( 'carousel_slider_speed' ),
		'carouselShowArrowOnHover'	=> BIT\blogistic_get_customizer_option( 'carousel_show_arrow_on_hover' ),		
		'carouselSlideToShow'	=> BIT\blogistic_get_customizer_option( 'carousel_no_of_columns' ),
		'slidesToScroll'	=> BIT\blogistic_get_customizer_option( 'carousel_slides_to_scroll' ),
		'carouselPrevIcon'	=> blogistic_parse_icon_picker_value( BIT\blogistic_get_customizer_option( 'carousel_slider_prev_arrow' ) ),
		'carouselNextIcon'	=> blogistic_parse_icon_picker_value( BIT\blogistic_get_customizer_option( 'carousel_slider_next_arrow' ) ),
		// theme mode
		'themeModeLightIcon'	=>	BIT\blogistic_get_customizer_option( 'blogistic_theme_mode_light_icon' ),
		'themeModeDarkIcon'	=>	BIT\blogistic_get_customizer_option( 'blogistic_theme_mode_dark_icon' ),

		'headerSticky'	=>	BIT\blogistic_get_customizer_option( 'menu_options_sticky_header' ),
		'breadcrumbSeparatorIcon'	=>	blogistic_parse_icon_picker_value( BIT\blogistic_get_customizer_option( 'breadcrumb_separator_icon' ) ),

		// category collection
		'catCollSliderArrow'	=>	BIT\blogistic_get_customizer_option( 'category_collection_slider_arrow' ),
		'catCollPrevArrow'	=>	blogistic_parse_icon_picker_value( BIT\blogistic_get_customizer_option( 'category_collection_prev_arrow' ) ),
		'catCollNextArrow'	=>	blogistic_parse_icon_picker_value( BIT\blogistic_get_customizer_option( 'category_collection_next_arrow' ) ),
		'catCollAutoplayOption'	=>	BIT\blogistic_get_customizer_option( 'category_collection_autoplay_option' ),
		'catCollAutoplaySpeed'	=>	BIT\blogistic_get_customizer_option( 'category_collection_autoplay_speed' ),
		'catCollSliderInfinite'	=>	BIT\blogistic_get_customizer_option( 'category_collection_slider_infinite' ),
		'catCollSliderSpeed'	=>	BIT\blogistic_get_customizer_option( 'category_collection_slider_speed' ),
		'catCollNumberOfColumns'	=>	BIT\blogistic_get_customizer_option( 'category_collection_number_of_columns' ),
		'catCollSlidesToShow'	=>	BIT\blogistic_get_customizer_option( 'category_collection_slides_to_show' ),
		'catCollSlidesToScroll'	=>	BIT\blogistic_get_customizer_option( 'category_collection_slides_to_scroll' ),
		'singleGalleryLightbox'	=>	BIT\blogistic_get_customizer_option( 'single_gallery_lightbox_option' )
	]);

	wp_localize_script( 'blogistic-navigation', 'blogisticNavigatioObject', [
		'menuCutoffOption'	=>	BIT\blogistic_get_customizer_option( 'menu_cutoff_option' ),
		'menuCutoffAfter'	=>	BIT\blogistic_get_customizer_option( 'menu_cutoff_after' ),
		'menuCutoffText'	=>	BIT\blogistic_get_customizer_option( 'menu_cutoff_text' )
	]);
...
add_action( 'wp_enqueue_scripts', 'blogistic_scripts' );
...
new Blogistic_Admin\Admin_Page();
...
if( !function_exists( 'blogistic_typo_fonts_url' ) ) :
	/**
	 ...
	 * @since 1.0.0
	 */
	function blogistic_typo_fonts_url() {
		$filter = BLOGISTIC_PREFIX . 'typo_combine_filter';
		...
		// custom button
		$blogistic_custom_button_text_typography_value = $action($filter, 'blogistic_custom_button_text_typography');
		// main banner
...
if( ! function_exists( 'blogistic_parse_icon_picker_value' ) ) :
	/**
	 * Function to return image url for icon picker
	 */
	function blogistic_parse_icon_picker_value ( $control ) {
		if( $control['type'] == 'svg' ) :
...
if( ! function_exists( 'blogistic_get_all_social_share' ) ) :
	/**
	 * All social share icons and urls
	 * 
	 * @since 1.0.0
	 */
	function blogistic_get_all_social_share() {
		$postUrl = 'http' . ( isset( $_SERVER['HTTPS'] ) ? 's' : '' ) . '://' . "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
        return [
			'fa-brands fa-facebook'	=>	[
				'label'	=>	esc_html__( 'Facebook', 'blogistic' ),
			...
			'fa-brands fa-square-x-twitter'	=>	[
				'label'	=>	esc_html__( 'Twitter', 'blogistic' ),
			...
			'fa-brands fa-linkedin'	=>	[
				'label'	=>	esc_html__( 'Linkedin', 'blogistic' ),
			...
			'fa-solid fa-envelope'	=>	[
				'label'	=>	esc_html__( 'Envelope', 'blogistic' ),
			...
			'fa-brands fa-instagram'	=>	[
				'label'	=>	esc_html__( 'Instagram', 'blogistic' ),
			...
			'fa-brands fa-whatsapp'	=>	[
				'label'	=>	esc_html__( 'Whatsapp', 'blogistic' ),
			...
			'fa-brands fa-reddit'	=>	[
				'label'	=>	esc_html__( 'Reddit', 'blogistic' ),
			...
			'fa-brands fa-weixin'	=>	[
				'label'	=>	esc_html__( 'Weixin', 'blogistic' ),
				'value'	=>	'https://widget.wechat.com/o/qrcode/',
			],
			'fa-brands fa-tumblr'	=>	[
				'label'	=>	esc_html__( 'Tumblr', 'blogistic' ),
			...
			'fa-brands fa-skype'	=>	[
				'label'	=>	esc_html__( 'Skype', 'blogistic' ),
				'value'	=>	'https://web.skype.com/share?url=',
			],
			'fa-brands fa-telegram'	=>	[
				'label'	=>	esc_html__( 'Telegram', 'blogistic' ),
				'value'	=>	'https://telegram.me/share/url?url=',
			],
			'fa-brands fa-pinterest'	=>	[
				'label'	=>	esc_html__( 'Pinterest', 'blogistic' ),
			...
			'fa-brands fa-digg'	=>	[
				'label'	=>	esc_html__( 'Digg', 'blogistic' ),
				'value'	=>	'http://digg.com/submit?url=',
			],
			'fa-brands fa-stumbleupon-circle'	=>	[
				'label'	=>	esc_html__( 'Stumbleupon', 'blogistic' ),
			...
			'fa-solid fa-copy'	=>	[
				'label'	=>	esc_html__( 'Copy', 'blogistic' ),
				'value'	=>	$postUrl,
			],
			'fa-solid fa-print'	=>	[
				'label'	=>	esc_html__( 'Print', 'blogistic' ),
				'value'	=>	'print',
			],
			'fa-brands fa-amazon'	=>	[
				'label'	=>	esc_html__( 'Amazon', 'blogistic' ),
				'value'	=>	'http://www.amazon.com/wishlist/add?u=',
			],
			'fa-brands fa-renren'	=>	[
				'label'	=>	esc_html__( 'Renren', 'blogistic' ),
				'value'	=>	'https://www.connect.renren.com/share/sharer?url=',
			],
			'fa-brands fa-trello'	=>	[
				'label'	=>	esc_html__( 'Trello', 'blogistic' ),
				'value'	=>	'https://trello.com/add-card?mode=popup&url=',
			],
			'fa-brands fa-viadeo'	=>	[
				'label'	=>	esc_html__( 'Viadeo', 'blogistic' ),
...
if( ! function_exists( 'blogistic_get_all_fontawesome_icons' ) ) :
	/**
	 ...
	 * 
	 */
	function blogistic_get_all_fontawesome_icons( $type = '' ) {
        $fontawesome_icons = [
...
add_action( 'after_setup_theme', function(){
	$theme_activation_date = get_option( 'blogistic_theme_activation_date_timestamp' );
	if( ! $theme_activation_date ) update_option( 'blogistic_theme_activation_date_timestamp', current_time( 'timestamp' ) );
});
