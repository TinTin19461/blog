...
jQuery( document ).ready(function( $ ){
    var ajaxUrl = blogisticThemeInfoObject.ajaxUrl, _wpnonce = blogisticThemeInfoObject._wpnonce
    // not having importer
        ...
        buttonContainer.each( function(){
            ...
            _thisButton.on( 'click', function( event ){
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {
                        "action": "blogistic_importer_plugin_action",
                        "_wpnonce": _wpnonce,
    ...
    // view all button
    var ViewAllContainer = $('#blogistic-info-page')
